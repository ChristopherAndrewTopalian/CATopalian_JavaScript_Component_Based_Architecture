...
class Drone
{
    constructor(id, startX, startY, speed = 2, maxDistance = 200)
    {
        ...
        this.controls = null; // Starts with no keyboard controls
    ...
    addKeyboardControlComponent() 
    {
        if (this.controls === null) 
        {
            // We pass 'this' so the component knows which drone it belongs to
            this.controls = new KeyboardControlComponent(this);
        }
    }

    removeKeyboardControlComponent() 
    {
        if (this.controls !== null) 
        {
            // Tell the component to cleanly kill its event listeners
            this.controls.destroy(); 
            // Delete the component from the drone's memory
            this.controls = null;    
        }
    }
