...
function makeInterface()
{
    ...
    btnKeyboardToggle.textContent = 'Keyboard Ability';
    ...
    btnKeyboardToggle.onclick = function() 
    {
        ...
        if (selectedDrone.controls == null) 
        {
            this.textContent = 'Keyboard On';

            // It's empty. Equip it.
            selectedDrone.addKeyboardControlComponent();
        ...
        {
            this.textContent = 'Keyboard Off';

            // It already has one. Remove it.
            selectedDrone.removeKeyboardControlComponent();
    ...
    componentsContainer.append(btnKeyboardToggle);
